...
class AnthropomorphicArm:
    ...
    def _create_robot(self):
        ...
        return DHRobot([L1, L2, L3, L4], name='Anthro3R')
...
for k, t in enumerate(time):
    ...
    tau_ff = robot.rne(q_ref, qd_ref, qdd_ref)
    print(' tau ff: ', tau_ff)
    ...
    #stima di tau_prime
    tau_prime = robot.rne(q, qd, np.zeros(n), gravity = g_0)
    #rhs = tau - C @ qd - g
    ...
    # Log
    q_log[k], qd_log[k], tau_log[k] = q, qd, tau
