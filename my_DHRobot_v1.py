...
class my_DHRobot_v1(Robot):
    ...
    def __init__(self, links, meshdir=None, **kwargs):
        ...
        for link in links:
            ...
            elif isinstance(link, my_DHRobot_v1):
...
class SerialLink(my_DHRobot_v1):
